...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-6 sm:py-12 bg-cyan-100 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white px-4 sm:px-10 py-6 sm:py-8 shadow rounded-lg sm:rounded-xl border-2 border-black">
          ...
          <p className="mt-4 text-center text-xs sm:text-sm text-gray-600">
            ...
            <Link href="/signin" className="text-cyan-700 hover:underline">
              Sign in
            </Link>
          </p>
        </div>
